      ...
      <>
        <div className={cx('menu')}>
          <div className={cx('menu__logo')}>
            <div className={cx('menu__logo-wrap')}>
              <Logo />
            </div>
