...
export default function Home({ textBlocks, projects, team, partners }) {
  const TextBlock = ({ name }) => (
    <TextBlockComponent data={textBlocks} name={name} />
  );
    ...
    <div className="wrap">
      ...
      <Layout home>
            ...
            <p className={"main-visual__description"}>
              ...
              >
                <g clipPath="url(#clip0_1696_932)">
                  <path
                    d="M206.003 99.79C137.335 77.6443 68.6677 138.149 0 116.003V161.953C68.6677 184.099 137.335 123.594 206.003 145.74V99.79Z"
                    fill="#00B4FF"
                  />
                  <path
                    d="M206.003 7.95005C137.335 -14.1957 68.6677 46.3086 0 24.1628V70.0828C68.6677 92.2286 137.335 31.7243 206.003 53.8701V7.95005Z"
                    fill="#FFD400"
                  />
                  <path
                    d="M206.003 43.8701C137.335 21.7244 68.6677 82.2286 0 60.0829V126.003C68.6677 148.149 137.335 87.6444 206.003 109.79V43.8701Z"
                    fill="#00B400"
                  />
                </g>
                <defs>
                  <clipPath id="clip0_1696_932">
                    <rect
                      ...
                      height="153.66"
                      fill="white"
                      transform="matrix(0.996917 -0.0784591 0 1 0 16.2129)"
                    />
                  </clipPath>
                </defs>
              </svg>
        ...
        <section className={"section"} id="projects">
          <h2 className={"section__heading section__heading_projects"}>
            Дизайн-
            <br />
            система
          </h2>
        ...
        <section className={"section"} id="partners">
          <h2 className={"section__heading section__heading_partners"}>
            Партнёры
          </h2>
        ...
        */}
        ...
        <section className={"section"} id="contacts">
          <h2 className={"section__heading section__heading_contacts"}>
            Почта
            <br />и соцсети
          </h2>
